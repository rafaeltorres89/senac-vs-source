<%@ Page Title="" Language="C#" MasterPageFile="~/SenacMapSite.Master" AutoEventWireup="true" CodeBehind="TurmaAluno.aspx.cs" Inherits="br.senac.sp.mapaaula.web.adm.TurmaAluno" %>
<asp:Content ID="TurmaAluno" ContentPlaceHolderID="content" runat="server">
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th>
                        <asp:Label ID="lblColIdAluno" runat="server" Text="Aluno" /></th>
    ...
    <div class="tab-pane" id="tabDetalhe" runat="server">
        ...
        <p>
            <asp:Label ID="lblDetIdAluno" runat="server" Text="Aluno" AssociatedControlID="txtIdAluno" />
            <asp:TextBox ID="txtIdAluno" runat="server" ToolTip="" MaxLength="60" />
        </p>
